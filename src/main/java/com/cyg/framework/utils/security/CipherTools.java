...
public class CipherTools {
    ...
    public static void main(String[] args){
    	String initKey = CipherTools.initKey("kkky");
    	System.out.println(initKey);
    	String encrypt = CipherTools.encrypt("123123", initKey);
    	System.out.println(encrypt);
    	String decrypt = CipherTools.decrypt("E2UXNQP3KLRX4", "a2treTEyMzQ1Njc4OTA5ODc2NTQzMjEw");
