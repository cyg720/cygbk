...
/**
* @Description: <p> Title:处理数值运算的辅助类：加法、减法、乘法、
 * 除数、四舍五入处理、格式化数值</p>
 * <p>传入double值，再用BigDecimal来计算
...
public class Arithmetic {
    ...
    public static void main(String[] args) {
        // 两个小数相加：
//        double v1 = 123452345234.9899999;
        // double v2 = 2.0;
       // String v3 = Arithmetic.formateArithmetic(v1 / 10000 * 10000);
//        String v3 = Arithmetic.formateArithmetic(v1);
//        System.out.println(Arithmetic.moneyCn("123400700"));
//        System.out.println(Arithmetic.separateMoney("123400700"));
//        System.out.println("v3===============================>>" + v3);
        System.out.println(Arithmetic.roundPrice(0.0001, 2));
//        System.out.println(Arithmetic.round(0.00000001, 4));
        
    }
    
    /**
     * 用于金钱单位的进位计算
     * 例：0.000001保留4位小数,结果为0.0001;保留2位小数为0.01
     * @param price 金额
     * @param scale 保留位数
     * @return
     */
    public static final double roundPrice(double price,int scale) {
        if (scale < 0) {
            throw new IllegalArgumentException(
                    "运算精度不能小于零");
        }
...
//    	System.out.println(b.setScale(scale, BigDecimal.ROUND_HALF_UP).stripTrailingZeros().toPlainString());
    	return b.setScale(scale, BigDecimal.ROUND_HALF_UP).doubleValue();
    }
    
    /*****************李东海新增,加法********************/
    public static double add(float d1,float d2){
    	double v1 = Double.parseDouble(String.valueOf(d1));
    	double v2 = Double.parseDouble(String.valueOf(d2));
    	double result = add(v1, v2);
    	return result;
    }
    
    public static double add(float d1,double d2){
    	double v1 = Double.parseDouble(String.valueOf(d1));
    	double v2 = d2;
    	double result = add(v1, v2);
    	return result;
    ...
    public static double add(double d1,float d2){
    	double v1 = d1;
    	double v2 = Double.parseDouble(String.valueOf(d2));
    	double result = add(v1, v2);
    	return result;
    ...
    /*****************李东海新增,减法********************/
    public static double sub(float d1,float d2){
    	double v1 = Double.parseDouble(String.valueOf(d1));
    	double v2 = Double.parseDouble(String.valueOf(d2));
    ...
    public static double sub(float d1,double d2){
    	double v1 = Double.parseDouble(String.valueOf(d1));
    	double v2 = d2;
    	double result = sub(v1, v2);
    	return result;
    ...
    public static double sub(double d1,float d2){
    	double v1 = d1;
    	double v2 = Double.parseDouble(String.valueOf(d2));
    	double result = sub(v1, v2);
    	return result;
    ...
    public static double mul(float d1,double d2){
    	double v1 = Double.parseDouble(String.valueOf(d1));
    	double v2 = d2;
    	double result = mul(v1, v2);
    	return result;
    ...
    public static double mul(double d1,float d2){
    	double v1 = d1;
    	double v2 = Double.parseDouble(String.valueOf(d2));
    	double result = mul(v1, v2);
    	return result;
    ...
    /*****************李东海新增,除法********************/
    public static double div(float d1,float d2){
    	double v1 = Double.parseDouble(String.valueOf(d1));
    	double v2 = Double.parseDouble(String.valueOf(d2));
    ...
    public static double div(float d1,double d2){
    	double v1 = Double.parseDouble(String.valueOf(d1));
    	double v2 = d2;
    	double result = div(v1, v2);
    	return result;
    ...
    public static double div(double d1,float d2){
    	double v1 = d1;
    	double v2 = Double.parseDouble(String.valueOf(d2));
    	double result = div(v1, v2);
    	return result;
    ...
    /*****************李东海新增,除法,带保留位数********************/
    public static double div(float d1,float d2,int d3){
    	double v1 = Double.parseDouble(String.valueOf(d1));
    	double v2 = Double.parseDouble(String.valueOf(d2));
    	double result = div(v1, v2, d3);
    	return result;
    }
    
    public static double div(float d1,double d2,int d3){
    	double v1 = Double.parseDouble(String.valueOf(d1));
    	double v2 = d2;
    	double result = div(v1, v2, d3);
    	return result;
    ...
    public static double div(double d1,float d2,int d3){
    	double v1 = d1;
    	double v2 = Double.parseDouble(String.valueOf(d2));
    	double result = div(v1, v2, d3);
    	return result;
